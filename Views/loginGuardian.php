...
<form action="<?php echo FRONT_ROOT ?>Guardian/opcionMenuPrincipal" method="post" style="background-color: #EAEDED;padding: 2rem !important;">
  ...
  <input type="submit" class="btn" value="verPrimerosPagosPendientes" name="opcion" placeholder="Ver guardianes" style="background-color:#DC8E47;color:white;" />
  <input type="submit" class="btn" value="cambiarTamanoACuidar" name="opcion" placeholder="Ver guardianes" style="background-color:#DC8E47;color:white;" />
